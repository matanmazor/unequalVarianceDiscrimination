function [] = BOLD2RDMs_gm(project_params,which_subjects,metric)
...
base_dir = '..\analyzed\DM6_unsmoothed';
...
for i_ROI = 1:7
    ...
    save(fullfile(base_dir,'group','rsa_gm',metric,[ROI,'_RDM.mat']),'RDM');
...
f = gcf;
exportgraphics(f,fullfile('figures','rsa_gm',[ROI,'_',metric,'.png']),'Resolution',300)
